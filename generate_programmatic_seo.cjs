...
<body class="lang-en">
    ...
    <div class="container">
        ...
        <div class="viewer-frame-container" style="width: 100%; height: 650px; border-radius: 18px; border: 1px solid rgba(59,130,246,0.25); overflow: hidden; margin: 40px 0; background: #000; box-shadow: 0 20px 50px rgba(0,0,0,0.6);">
            <iframe src="/?ref=${page.ref}" style="width: 100%; height: 100%; border: none;" title="Interactive Studios-Pro App Widget"></iframe>
        </div>

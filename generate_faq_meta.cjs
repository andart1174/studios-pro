    ...
    <div class="container">
        ...
        <div data-en>
            <div class="question">
                ...
                <p><strong>A1:</strong> No. Studios-Pro is a 100% browser-based platform. Whether you are analyzing CAD data in Jewelry Maker Pro, or recording videos in 4D Figure Builder, all computations are securely handled within your web browser.</p>
            </div>
            <div class="question">
        ...
        <div data-fr>
            <div class="question">
                ...
                <p><strong>R1:</strong> Non. Studios-Pro est une plateforme 100 % basée sur le navigateur. Que vous analysiez des données CAO dans Jewelry Maker Pro ou enregistriez des vidéos dans 4D Figure Builder, tous les calculs sont effectués en toute sécurité dans votre navigateur web.</p>
            </div>
            <div class="question">

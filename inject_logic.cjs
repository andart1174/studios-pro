...
<body>
  ...
  <script>
    ...
    let svgText = "";
    try {
      svgText = decodeURIComponent(escape(window.atob(base64Data)));
    } catch (e) {
      try {
        svgText = window.atob(base64Data);
      } catch (err) {
...
<body>
  ...
  <script>
    ...
    let code = "";
    try {
      code = decodeURIComponent(escape(window.atob(base64Data)));
    } catch (e) {
      try {
        code = window.atob(base64Data);
      } catch (err) {
